...
def main():
    ...
    ADD_A_COVER_LETTER = bool(config["Resume Options"]["add_a_cover_letter"])
    path_to_cover_letter = os.path.join(os.getcwd(), 'cover letter', f'{USERNAME.split("@")[0]}.txt')
    ...
    with open_web_driver() as web_driver:
        ...
        submit_to_the_vacancy_on_the_all_pages(web_driver, TITLE_OF_RESUME, ADD_A_COVER_LETTER, path_to_cover_letter)
